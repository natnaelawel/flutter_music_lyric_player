...
import 'package:flutter_audio_query/flutter_audio_query.dart'
    show FlutterAudioQuery, PlaylistInfo, ResourceType, SongInfo;
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
        ...
        itemBuilder: (context, songIndex) {
          MediaItem song = songList[songIndex];
                ...
                return ListItemWidget(
                  ...
                  subtitle: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        "Duration: ${Utility.parseToMinutesSeconds(song.duration!.inMilliseconds)}",
                        style: TextStyle(
